...
public class testCase_API_03 {
    ...
    public void TestCase03() throws InterruptedException {
        ...
        requestParams1.put("password", "justChecking");
        requestParams1.put("confirmpassword", "justChecking");
        ...
        requestParams2.put("password", "justChecking");
        ...
        RestAssured.baseURI = "https://content-qtripdynamic-qa-backend.azurewebsites.net/api/v1/reservations";
        RequestSpecification httpReq3 = RestAssured.given();
        JSONObject requestParams3 = new JSONObject();
        requestParams3.put("userId", userId);
        requestParams3.put("name", "Baduser");
        ...
        Assert.assertEquals(name, "[Baduser]", "Failed to validate the adventureName");//since used name as email
    }
}
